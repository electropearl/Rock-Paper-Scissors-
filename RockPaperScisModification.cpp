...
int main()
{
    ...
    while (response == 'Y' ||  response == 'y')   //Step 6
    {
        ...
        selection2 = alphabet[rand() % 26];

        cout << "Computer Picked: "<<selection2 <<endl;
...
void displayRules()
{
    cout << "  Welcome to the game of Rock, Paper, " 
         << "and Scissors." << endl;
    cout << "  This is a game for one player. For each "
         << "game, each" << endl;   
    cout << " select one of the objects, Rock, "
         << "Paper or Scissors." << endl;
    cout << " The rules for winning the game are: " << endl;
    cout << "1. If both you and the computer select the same object, it "
         << "is a tie." << endl;
    cout << "2. Rock breaks Scissors: So the player or computer who selects "
         << "Rock wins." << endl;
    cout << "3. Paper covers Rock: So the player or computer who selects " 
         << "Paper wins." << endl;
    cout << "4. Scissors cuts Paper: So the player or computer who selects "
...
void displayResults(int gCount, int wCount1, int wCount2)
{
    cout << "The total number of plays: " << gCount 
         << endl;
    cout << "The number of plays won by you is: " 
         << wCount1 << endl;
    cout << "The number of plays won by computer is: " 
         << wCount2 << endl;
}